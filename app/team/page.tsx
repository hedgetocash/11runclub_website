...
/* Sobald echte Fotos vorliegen, hier ergänzen und unten in TEAM als `img` eintragen:
...
const TEAM: TeamMember[] = [
  {
    ...
    tags: ['MARATHON', 'GROUPRIDE', 'EX-FUSSBALL'],
  },
  {
    name: 'EMMA',
    handle: '@emmajacot',
    ...
    tags: ['TRIATHLON', 'EXPLORER-RUNS', 'WINTERLIEBE'],
  },
  {
    name: 'NILS',
    ...
    tags: ['EX-EISHOCKEY', 'RENNRAD', 'FOTOGRAFIE'],
  },
  {
    name: 'ANNA',
    handle: '@annaednaa',
    ...
    tags: ['ULTRA-TRAIL', 'BERGLAUF', 'EX-HANDBALL'],
  },
]
    ...
    <>
      ...
      >
        ...
        <Reveal delay={160}>
          ...
          >
            Wir vier treffen uns mit der Community jede Woche am SOL-ID — ganz ohne
            Anmeldung. Schreib uns in der WhatsApp-Gruppe, wenn du Fragen hast.
          </p>
        </Reveal>
        <Reveal delay={220}>
