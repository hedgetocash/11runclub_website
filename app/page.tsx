      ...
      >
        {[
          ...
          <div key={lbl} style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 10, letterSpacing: '0.2em', color: 'var(--ash)', marginTop: 2 }}>
              {lbl}
            </div>
          </div>
        ))}
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 560 320" style={{ width: '100%', height: 'auto' }}>
        ...
        {/* Richtungspfeile */}
        <g fill="#EE3829">
          <path d="M0,-4.5 L8,0 L0,4.5" transform="translate(264,232) rotate(-19)"/>
          <path d="M0,-4.5 L8,0 L0,4.5" transform="translate(350,158) rotate(-93)"/>
          <path d="M0,-4.5 L8,0 L0,4.5" transform="translate(199,93) rotate(108)"/>
          <path d="M0,-4.5 L8,0 L0,4.5" transform="translate(131,207) rotate(85)"/>
        </g>
        {/* Start/Ziel */}
        <circle cx="148" cy="237" r="9" fill="none" stroke="#EE3829" strokeWidth="2"/>
      ...
      >
        → Beispielroute: Aare · Feldbrunnen · St. Niklaus · Verenaschlucht · Steingruben.
...
function PinnedEvent() {
  ...
  useEffect(() => {
    ...
    const stage = (p: number, a: number, b: number) => clamp01((p - a) / (b - a))
      ...
      <div className="pin-wrap" id="events" ref={pinRef}>
        <section className="pin-event" ref={eventRef}>
          ...
          <div className="pin-event__row">
            ...
            <Link href="/enter-hillclimb" className="btn btn--chalk">
              Zur Race-Page →
            </Link>
          </div>
        </section>
    ...
    >
      ...
      <div style={{ position: 'relative', maxWidth: 900 }}>
        <Reveal>
          ...
          >
            <span style={{ display: 'inline-block', width: 34, height: 2, background: 'rgba(244,241,235,0.7)', flexShrink: 0 }} />
            Kilometer sammeln
          </div>
        </Reveal>
        ...
        <Reveal delay={160}>
          ...
          >
            Tritt unserem offiziellen Strava-Club bei und sammle mit der ganzen Community Kilometer.
            Jede Runde zählt — egal ob Tuesday Run, Longrun oder Solo-Training zwischendurch.
          </p>
        </Reveal>
          ...
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'center' }}>
            <a
              ...
              onMouseEnter={e => {
                ...
                ;(e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 8px 24px rgba(252,76,2,0.4)'
              }}
              onMouseLeave={e => {
  ...
  return (
    <div className="slogan" aria-hidden="true">
      <div className="slogan__track" ref={trackRef}>
        ...
        <span style={{ color: 'transparent', WebkitTextStroke: '1.5px var(--black)' }}>
          Improve together.
        </span>
        <span>Enjoy together.</span>
        <span style={{ color: 'transparent', WebkitTextStroke: '1.5px var(--black)' }}>·</span>
      </div>
    </div>
  )
}
  ...
  return (
    <>
      ...
      >
        ...
        >
          Dein<br />
          <span style={{ color: 'transparent', WebkitTextStroke: '2.5px var(--black)' }}>
            Runclub
          </span>{' '}
          in<br />
      ...
      >
        ...
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: 'clamp(1fr,1.1fr,1fr) clamp(1fr,.9fr,1fr)',
        ...
        >
          ...
          <div>
            <Reveal delay={140}>
              <div style={{ borderTop: '1px solid rgba(244,241,235,0.18)' }}>
                {[
                  { k: 'WANN', v: 'Di — 18:30' },
      ...
      <section
        id="formats"
        style={{ padding: 'clamp(70px,10vw,140px) clamp(20px,4vw,56px)' }}
      >
        <Reveal>
        ...
        <Reveal delay={60}>
          ...
          >
            Mehr als nur<br />geradeaus laufen.
          </h2>
        </Reveal>
        <Reveal delay={120}>
          <p
      ...
      >
        ...
        <Reveal delay={120}>
          <p style={{ color: '#555', maxWidth: 520, margin: '18px auto 0', lineHeight: 1.6 }}>
            Alles Wichtige läuft über unsere WhatsApp-Community — Termine, Strecken,
            spontane Runs. Auf Strava sammeln wir die Kilometer.
          </p>
        </Reveal>
